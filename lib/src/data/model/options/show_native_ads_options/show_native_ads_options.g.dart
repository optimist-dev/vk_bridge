...
class _$ShowNativeAdsOptions extends ShowNativeAdsOptions {
  ...
  _$ShowNativeAdsOptions._({this.adFormat}) : super._() {
    if (adFormat == null) {
      throw new BuiltValueNullFieldError('ShowNativeAdsOptions', 'adFormat');
    }
  }
...
class ShowNativeAdsOptionsBuilder
  ...
  _$ShowNativeAdsOptions build() {
    final _$result = _$v ?? new _$ShowNativeAdsOptions._(adFormat: adFormat);
    replace(_$result);
    return _$result;
  }
}
